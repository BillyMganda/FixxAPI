...
{
    public class user_auth_service : Iuser_auth_service
    {
        private readonly Data_Context _context;
        private readonly IConfiguration _configuration;
        private readonly IHttpContextAccessor _HttpContextAccessor;
        public user_auth_service(Data_Context context, IConfiguration configuration, IHttpContextAccessor httpContextAccessor)
        {
            _context = context;
        ...
        public async Task<users> save_user(user_add_dto dto)
        {
